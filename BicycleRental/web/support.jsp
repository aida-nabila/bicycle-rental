...
<body>
    ...
    <div class="support-container">
        ...
        <p class="support-description">Need help with your bicycle rental? Find answers to common questions below or contact us for further assistance.</p>
        
        <h2 class="faq-title">FAQs</h2>
        <p class="faq-subtitle">FAQs to get you started</p>
        ...
        <p class="help-text">Send us a message and we will find the best way to support you.</p>
        
         <a href="contactSupport.jsp" class="contact-support">
            <div class="contact-box">
                <div class="contact-inner-box">
                    <img src="img/chat-icon.png" class="chat-icon" alt=""/>
                    <p class="contact-text">Contact Support</p>
                    <img src="img/arrow-icon.png" alt="Arrow" class="contact-arrow">
                </div>
            </div>
        </a>
    </div>
